  ...
  const uploadFiles = async(file) => {
    ...
    uploadTask.on(
      ...
      (snapshot) => {
        ...
        setProgress(prog);
        getDownloadURL(sotrageRef).then((url) => {
          setUrl(url)
    ...
    <div className='upload'>
        ...
        <div className="userUpdateUpload">
          <div className='card'>
            ...
            <h1>Type of plastic</h1>
              <input type='text' placeholder='Plastic name...' onChange={(e) => setImageName(e.target.value)} value={imageName}  required />
              <Avatar src={url} sx={{ width: 150, height: 150 }} />
              <input type='file' multiple onChange={handleImageChange} />
              <button> <label onClick={uploadFiles} > <PublishIcon className='userUpdateIcon' alt="" /></label></button>
